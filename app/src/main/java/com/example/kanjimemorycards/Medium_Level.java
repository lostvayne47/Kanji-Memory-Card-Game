...
public class Medium_Level extends AppCompatActivity {
    ...
    int[] imageArray = {R.drawable.kanji1, R.drawable.tree, R.drawable.kanji3, R.drawable.river, R.drawable.kanji5, R.drawable.fire,R.drawable.kanji6, R.drawable.water};      //set of images to be shuffled randomly
    int[][] solutions={{R.drawable.kanji1, R.drawable.tree},{R.drawable.kanji3, R.drawable.river},{R.drawable.kanji5, R.drawable.fire},{R.drawable.kanji6, R.drawable.water}};  //solution set manually created
    ...
    public void checkSolution(int[] toCheck){
        ...
        for(int i=0;i<4;i++){    //looping through solution set which is a matrix of 4x2 value of matrix will change with levels
            int j=0;
...
//          }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        im1=(ImageView)findViewById(R.id.mediumimageView1);   //image view 1 to 8 initialized
        ...
        im7=(ImageView)findViewById(R.id.mediumimageView7);
        im8=(ImageView)findViewById(R.id.mediumimageView8);
